...
const Message = () => {
  return (
    <section className="relative py-24 bg-[#F5F5F7] dark:bg-[#050505] overflow-hidden border-t border-black/5 dark:border-white/5 transition-colors duration-500 font-sans">
      ...
      {/* Background Decorative Glow - Maroon Touch */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#722F37]/5 dark:bg-[#722F37]/10 blur-[150px] rounded-full -mr-40 -mt-40 pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <h2 className="text-black dark:text-[#F0F8FF] text-5xl md:text-8xl font-black uppercase tracking-tighter leading-[0.8]">
                SECURE <br /> 
                <span className="text-[#722F37]">UP REGION</span> <br />
                <span className="text-zinc-400 dark:opacity-20 italic font-light text-4xl md:text-6xl tracking-normal">Risk Intelligence.</span>
              </h2>
          ...
          <div className="lg:col-span-7 bg-white dark:bg-zinc-900/20 p-8 md:p-12 rounded-3xl border border-black/5 dark:border-white/5 backdrop-blur-sm relative overflow-hidden shadow-xl dark:shadow-none">
            <motion.div
            ...
            >
              <h3 className="text-black dark:text-[#F0F8FF] text-xl md:text-2xl font-bold uppercase tracking-tight border-l-4 border-[#722F37] pl-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-6">
                <div className="flex gap-4 group">
                  ...
                  <div>
                    <h4 className="text-black dark:text-white text-xs font-black uppercase tracking-widest mb-1">Risk Mitigation</h4>
                ...
                <div className="flex gap-4 group">
                  ...
                  <div>
                    <h4 className="text-black dark:text-white text-xs font-black uppercase tracking-widest mb-1">Expert Training</h4>
              ...
              <div className="flex items-center justify-between pt-4">
                <div className="flex flex-col">
                  <span className="text-black dark:text-white font-black uppercase tracking-tighter text-lg">Mahaveer Tactical</span>
                  <span className="text-[#722F37] text-[10px] font-bold uppercase tracking-[0.3em]">Amethi Division</span>
                </div>
                <Eye className="text-black/5 dark:text-white/5 absolute -right-4 -bottom-4" size={120} />
              </div>
            </motion.div>
          </div>
